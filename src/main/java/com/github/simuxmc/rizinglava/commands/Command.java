...
public abstract class Command extends CommandAPICommand {
	...
	public static void registerAllCommands(File jarFile, Logger logger) {
		try {
			Class<Command>[] commandClasses = FileUtils.getClasses("com.github.simuxmc.rizinglava.commands",
